...
# Export routes
@app.route('/export/attendance/csv/<int:course_id>')
@login_required
def export_attendance_csv(course_id):
    ...
    # Export to CSV
    return export_to_csv(attendance_records, course)

@app.route('/export/attendance/pdf/<int:course_id>')
@login_required
def export_attendance_pdf(course_id):
    ...
    # Export to PDF
    return export_to_pdf(attendance_records, course)
